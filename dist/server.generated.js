...
eval("\n\nObject.defineProperty(exports, \"__esModule\", ({\n    value: true\n}));\n\nvar _express = __webpack_require__(/*! express */ \"express\");\n\nvar _express2 = _interopRequireDefault(_express);\n\nvar _auth = __webpack_require__(/*! ../controllers/auth.controller */ \"./server/controllers/auth.controller.js\");\n\nvar _login = __webpack_require__(/*! ../../middlewares/login.middleware */ \"./middlewares/login.middleware.js\");\n\nvar _login2 = _interopRequireDefault(_login);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst router = _express2.default.Router();\n\nrouter.route('/auth/login').post(_auth.signIn);\n\nrouter.route('/auth/logout', _login2.default.requireSignIn).get(_auth.signOut);\n\nexports[\"default\"] = router;\n\n//# sourceURL=webpack://mern-voterecs/./server/routers/auth.routes.js?");
